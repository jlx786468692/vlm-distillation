...
| **[候选集生成完整指南](候选集生成完整指南.md)** | 三阶段构建、数据源、修复方案 | ⭐ **必读** |
| **[环境依赖说明](环境依赖说明.md)** | 安装步骤、依赖包、系统要求 | 新手入门 |
| **[Prompt生成指南](Prompt生成指南.md)** | Prompt模板设计与优化 | 标签生成 |
...
| **候选集生成** | [候选集生成完整指南](候选集生成完整指南.md) | 三阶段构建、数据源、修复方案 |
| **Prompt设计** | [Prompt生成指南](Prompt生成指南.md) | 模板类型、优化策略、配置方法 |
